...
//> Classes interpreter-visit-class
  ...
  public Void visitClassStmt(Stmt.Class stmt) {
    ...
    // --- NEW: build metaclass with class methods ---
    ...
    // Inherit class methods from superclass's metaclass (nice-to-have).
    LoxClass metaclassSuperclass = null;
    if (superclass != null) {
      metaclassSuperclass = ((LoxClass) superclass).klass; // superclass's metaclass
    }
    ...
    // --- Instance methods (existing behavior) ---
